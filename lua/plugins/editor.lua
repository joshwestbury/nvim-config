return {
  ...
  -- Project-wide search and replace with visual preview
  {
    ...
    keys = {
      ...
      { '<leader>sw', function() require('spectre').open_visual({select_word=true}) end, desc = 'Search current word (Spectre)', mode = 'n' },
      { '<leader>sw', function() require('spectre').open_visual() end, desc = 'Search selection (Spectre)', mode = 'v' },
      { '<leader>sp', function() require('spectre').open_file_search({select_word=true}) end, desc = 'Search in current file (Spectre)' },
    },
  },
